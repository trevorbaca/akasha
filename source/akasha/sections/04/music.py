...
def V1(voice, time_signatures):
    ...
    voice.extend(music)
    music = baca.make_mmrests(time_signatures(14, 15), head=voice.get_name())
    voice.extend(music)
    ...
    voice.extend(music)
    music = baca.make_mmrests(time_signatures(20), head=voice.get_name())
    voice.extend(music)
    ...
    voice.extend(music)
    music = baca.make_mmrests(time_signatures(24), head=voice.get_name())
    voice.extend(music)
    music = baca.make_repeat_tied_notes(time_signatures(25, 26))
    voice.extend(music)
    music = baca.make_mmrests(time_signatures(27), head=voice.get_name())
    voice.extend(music)
...
def V2(voice, time_signatures):
    ...
    music = baca.make_repeat_tied_notes(time_signatures(23))
    voice.extend(music)
    music = baca.make_mmrests(time_signatures(24, 25), head=voice.get_name())
    voice.extend(music)
...
def VA(voice, time_signatures):
    ...
    voice.extend(music)
    music = baca.make_mmrests(time_signatures(6), head=voice.get_name())
    voice.extend(music)
    music = library.make_glissando_rhythm(
        time_signatures(7),
    )
    ...
    voice.extend(music)
    music = baca.make_mmrests(time_signatures(13, 15), head=voice.get_name())
    voice.extend(music)
    music = baca.make_repeat_tied_notes(time_signatures(16))
    voice.extend(music)
    music = baca.make_mmrests(time_signatures(17, 22), head=voice.get_name())
    voice.extend(music)
...
def VC(voice, time_signatures):
    ...
    voice.extend(music)
    music = baca.make_mmrests(time_signatures(13, 14), head=voice.get_name())
    voice.extend(music)
    ...
    voice.extend(music)
    music = baca.make_mmrests(time_signatures(16, 22), head=voice.get_name())
    voice.extend(music)
    music = library.make_polyphony_rhythm(
        time_signatures(23),
        rotation=-4,
