...
def V1(voice, time_signatures):
    ...
    voice.extend(music)
    music = baca.make_mmrests(time_signatures(30), head=voice.get_name())
    voice.extend(music)
...
def V2(voice, time_signatures):
    ...
    voice.extend(music)
    music = baca.make_mmrests(time_signatures(11, 12), head=voice.get_name())
    voice.extend(music)
    music = baca.make_repeated_duration_notes(time_signatures(13, 20), [(1, 4)])
    voice.extend(music)
    music = baca.make_repeat_tied_notes(time_signatures(21, 22))
    voice.extend(music)
    music = baca.make_mmrests(time_signatures(23, 24), head=voice.get_name())
    voice.extend(music)
    music = baca.make_repeat_tied_notes(time_signatures(25, 26))
    voice.extend(music)
    music = baca.make_mmrests(time_signatures(27), head=voice.get_name())
...
def VC(voice, time_signatures):
    ...
    voice.extend(music)
    music = baca.make_mmrests(time_signatures(15, 16), head=voice.get_name())
    voice.extend(music)
