...
def make_accelerando_rhythm_function(
    ...
    rmakers.feather_beam_function(voice, beam_rests=True, stemlet_length=0.75, tag=tag)
...
def make_polyphony_rhythm_function(time_signatures, *, force_rest_lts=None, rotation=0):
    counts = [4, 14, 4, 6, 18]
