    ...
    \context Score = "Score" \with {
        ...
        \context GlobalContext = "GlobalContext" <<
            ...
            \context GlobalSkips = "GlobalSkips" {
                ...
                \newSpacingSection
                \set Score.proportionalNotationDuration = #(ly:make-moment 3 88) %%! SEGMENT:SPACING
                s1 * 3/2
                ^ \markup {
                    \column
                        {
