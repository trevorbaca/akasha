...
%@% ^ \markup \baca-dark-cyan-markup "[8'58'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
...
%@% ^ \markup \baca-dark-cyan-markup "[9'25'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
...
%@% ^ \markup \baca-dark-cyan-markup "[9'28'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
...
%@% ^ \markup \baca-dark-cyan-markup "[9'34'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
...
%@% ^ \markup \baca-dark-cyan-markup "[9'40'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
...
%@% ^ \markup \baca-dark-cyan-markup "[9'50'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
...
G_ViolinIMusicVoice = {
    ...
    - \tweak bound-details.left.text \markup \baca-left "tasto + 1/4 scratch" %! PiecewiseIndicatorCommand(1)
    ...
    - \tweak bound-details.right.text \markup \baca-right "FB"             %! PiecewiseIndicatorCommand(1)
    - \tweak bound-details.right.padding #0.5                              %! PiecewiseIndicatorCommand(1)
    - \tweak bound-details.right.stencil-align-dir-y #center               %! PiecewiseIndicatorCommand(1)
    \startTextSpan                                                         %! PiecewiseIndicatorCommand(1)
    \glissando                                                             %! SpannerCommand
    ...
    - \abjad_dashed_line_with_arrow                                        %! PiecewiseIndicatorCommand(1)
    - \tweak bound-details.left.text \markup \baca-left "trans."           %! PiecewiseIndicatorCommand(1)
    - \tweak bound-details.right.text \markup \baca-right "XFB"            %! PiecewiseIndicatorCommand(1)
    - \tweak bound-details.right.padding #0.5                              %! PiecewiseIndicatorCommand(1)
    - \tweak bound-details.right.stencil-align-dir-y #center               %! PiecewiseIndicatorCommand(1)
    \startTextSpan                                                         %! PiecewiseIndicatorCommand(1)
    \glissando                                                             %! SpannerCommand
...
%@% \override Staff.Clef.color = ##f                                       %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    \>                                                                     %! EXPLICIT_DYNAMIC:_set_status_tag:PiecewiseIndicatorCommand(1)
    - \abjad_dashed_line_with_arrow                                        %! PiecewiseIndicatorCommand(1)
    - \tweak bound-details.left.text \markup \baca-left "tasto + scratch moltiss." %! PiecewiseIndicatorCommand(1)
    - \tweak bound-details.right.text \markup \baca-right "tasto + 1/4 scratch" %! PiecewiseIndicatorCommand(1)
    - \tweak bound-details.right.padding #0.5                              %! PiecewiseIndicatorCommand(1)
    - \tweak bound-details.right.stencil-align-dir-y #center               %! PiecewiseIndicatorCommand(1)
    \startTextSpan                                                         %! PiecewiseIndicatorCommand(1)
    \glissando                                                             %! SpannerCommand
...
%%% \once \override Staff.Clef.X-extent = ##f                              %! OverrideCommand(1):MEASURE_200:SHIFTED_CLEF
%%% \once \override Staff.Clef.extra-offset = #'(-2.75 . 0)                %! OverrideCommand(1):MEASURE_200:SHIFTED_CLEF
