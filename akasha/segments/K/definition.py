...
maker(
    ...
    baca.generalized_hairpin('ff < fff', selector=baca.leaves()[:-1]),
    )
...
maker(
    (['v1', 'v2', 'va', 'vc'], 9),
    baca.generalized_hairpin('sffp < fff', selector=baca.leaves()[:3]),
    baca.generalized_hairpin('fff > p', selector=baca.leaves()[-2:]),
    baca.transition(
...
maker(
    (['v1', 'v2', 'va', 'vc'], 10),
    baca.generalized_hairpin('sffp < fff', selector=baca.leaves()[:2]),
    baca.generalized_hairpin('fff > p', selector=baca.leaves()[-2:]),
    baca.transition(
        baca.markups.pos_ord(),
        baca.markups.XP(),
...
maker(
    (['v1', 'v2', 'va', 'vc'], 12),
    baca.generalized_hairpin('sffp > pp', selector=baca.leaves()[:-1]),
    baca.transition(
        baca.markups.pos_ord(),
        baca.markups.XT(),
        selector=baca.leaves()[:-1],
...
maker(
    ('vc', (14, 15)),
    baca.generalized_hairpin('sffp < f', selector=baca.leaves()[:4]),
    )
...
maker(
    ...
    baca.trill_spanner(),
    baca.generalized_hairpin('sffp < f'),
    )
...
maker(
    (['v1', 'v2', 'va', 'vc'], 19),
    baca.generalized_hairpin('sf < fff', selector=baca.leaves()[:3]),
    baca.generalized_hairpin('fff > f', selector=baca.leaves()[-2:]),
    baca.transition(
        baca.markups.pos_ord(),
        baca.markups.XP(),
        selector=baca.leaves()[:3],
...
maker(
    (['v1', 'v2', 'va', 'vc'], (20, 21)),
    baca.generalized_hairpin('sffp < fff', selector=baca.leaves()[:4]),
    baca.transition(
        baca.markups.pos_ord(),
        baca.markups.XP(),
