...
%@% ^ \baca-dark-cyan-markup "[16'30'']"                                       %! CLOCK_TIME_MARKUP:_label_clock_time
    ...
    %@% ^ \baca-dark-cyan-markup "[16'31'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
        \stopTextSpan                                                          %! _attach_metronome_marks(1)
    %@% - \abjad_invisible_line                                                %! _attach_metronome_marks(2)
    %@% - \baca_metronome_mark_spanner_left_text 2 0 1 "38"                    %! _attach_metronome_marks(2)
    %@% \startTextSpan                                                         %! _attach_metronome_marks(2)
        - \abjad_invisible_line                                                %! _attach_metronome_marks(3)
        - \baca_metronome_mark_spanner_colored_left_text 2 0 1 "38" #'blue     %! _attach_metronome_marks(3)
        \startTextSpan                                                         %! _attach_metronome_marks(3)
