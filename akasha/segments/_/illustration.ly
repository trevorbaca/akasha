            ...
            \context StringQuartetStaffGroup = "StringQuartetStaffGroup" <<
                ...
                \context ViolinOneMusicStaff = "ViolinOneMusicStaff" {
                    \context ViolinOneMusicVoice = "ViolinOneMusicVoice" {
                        ...
                        \set ViolinOneMusicStaff.instrumentName = \markup { %! EXPLICIT_INSTRUMENT_COMMAND:4
                            \hcenter-in %! EXPLICIT_INSTRUMENT_COMMAND:4
                                ...
                                \line %! EXPLICIT_INSTRUMENT_COMMAND:4
                                    { %! EXPLICIT_INSTRUMENT_COMMAND:4
                                        ...
                                        I %! EXPLICIT_INSTRUMENT_COMMAND:4
                                    } %! EXPLICIT_INSTRUMENT_COMMAND:4
                            } %! EXPLICIT_INSTRUMENT_COMMAND:4
                        \set ViolinOneMusicStaff.shortInstrumentName = \markup { %! EXPLICIT_INSTRUMENT_COMMAND:4
                            \hcenter-in %! EXPLICIT_INSTRUMENT_COMMAND:4
                        ...
                        \once \override ViolinOneMusicStaff.InstrumentName.color = #(x11-color 'blue) %! EXPLICIT_INSTRUMENT_COLOR:1
                        \once \override ViolinOneMusicStaff.Clef.color = #(x11-color 'blue) %! EXPLICIT_CLEF_COLOR:7
                        %%% \override ViolinOneMusicStaff.Clef.color = ##f %! EXPLICIT_CLEF_UNCOLOR:8
                        \set ViolinOneMusicStaff.forceClef = ##t %! EXPLICIT_CLEF_COMMAND:9
                        R1 * 3/8
                        ^ \markup {
                            \column
                                {
                                    ...
                                    %%%                 "violin I" %! EXPLICIT_INSTRUMENT_CHANGE_MARKUP:2
                                    %%%     } %! EXPLICIT_INSTRUMENT_CHANGE_MARKUP:2
                                            ...
                                            \with-color %! EXPLICIT_INSTRUMENT_CHANGE_COLORED_MARKUP:3
                                                ...
                                                \override %! EXPLICIT_INSTRUMENT_CHANGE_COLORED_MARKUP:3
                                                    ...
                                                    \box %! EXPLICIT_INSTRUMENT_CHANGE_COLORED_MARKUP:3
                                                        "violin I" %! EXPLICIT_INSTRUMENT_CHANGE_COLORED_MARKUP:3
                                        } %! EXPLICIT_INSTRUMENT_CHANGE_COLORED_MARKUP:3
                                }
                            }
                        \set ViolinOneMusicStaff.instrumentName = \markup { %! EXPLICIT_INSTRUMENT_SHADOW_COMMAND:6
                            \hcenter-in %! EXPLICIT_INSTRUMENT_SHADOW_COMMAND:6
                                ...
                                \line %! EXPLICIT_INSTRUMENT_SHADOW_COMMAND:6
                                    { %! EXPLICIT_INSTRUMENT_SHADOW_COMMAND:6
                                        ...
                                        I %! EXPLICIT_INSTRUMENT_SHADOW_COMMAND:6
                                    } %! EXPLICIT_INSTRUMENT_SHADOW_COMMAND:6
                            } %! EXPLICIT_INSTRUMENT_SHADOW_COMMAND:6
                        \set ViolinOneMusicStaff.shortInstrumentName = \markup { %! EXPLICIT_INSTRUMENT_SHADOW_COMMAND:6
                            \hcenter-in %! EXPLICIT_INSTRUMENT_SHADOW_COMMAND:6
                        ...
                        \override ViolinOneMusicStaff.InstrumentName.color = #(x11-color 'DarkCyan) %! EXPLICIT_INSTRUMENT_SHADOW_COLOR:5
                        \override ViolinOneMusicStaff.Clef.color = #(x11-color 'DarkCyan) %! EXPLICIT_CLEF_SHADOW_COLOR:11
                ...
                \context ViolinTwoMusicStaff = "ViolinTwoMusicStaff" {
                    \context ViolinTwoMusicVoice = "ViolinTwoMusicVoice" {
                        ...
                        \set ViolinTwoMusicStaff.instrumentName = \markup { %! EXPLICIT_INSTRUMENT_COMMAND:4
                            \hcenter-in %! EXPLICIT_INSTRUMENT_COMMAND:4
                                #16 %! EXPLICIT_INSTRUMENT_COMMAND:4
                                \line %! EXPLICIT_INSTRUMENT_COMMAND:4
                                    { %! EXPLICIT_INSTRUMENT_COMMAND:4
                                        Violin %! EXPLICIT_INSTRUMENT_COMMAND:4
                                        II %! EXPLICIT_INSTRUMENT_COMMAND:4
                                    } %! EXPLICIT_INSTRUMENT_COMMAND:4
                            } %! EXPLICIT_INSTRUMENT_COMMAND:4
                        \set ViolinTwoMusicStaff.shortInstrumentName = \markup { %! EXPLICIT_INSTRUMENT_COMMAND:4
                            \hcenter-in %! EXPLICIT_INSTRUMENT_COMMAND:4
                                #10 %! EXPLICIT_INSTRUMENT_COMMAND:4
                                \line %! EXPLICIT_INSTRUMENT_COMMAND:4
                                    { %! EXPLICIT_INSTRUMENT_COMMAND:4
                        ...
                        \clef "treble" %! EXPLICIT_CLEF_COMMAND:10
                        \once \override ViolinTwoMusicStaff.InstrumentName.color = #(x11-color 'blue) %! EXPLICIT_INSTRUMENT_COLOR:1
                        \once \override ViolinTwoMusicStaff.Clef.color = #(x11-color 'blue) %! EXPLICIT_CLEF_COLOR:7
                        %%% \override ViolinTwoMusicStaff.Clef.color = ##f %! EXPLICIT_CLEF_UNCOLOR:8
                        \set ViolinTwoMusicStaff.forceClef = ##t %! EXPLICIT_CLEF_COMMAND:9
                        R1 * 3/8
                        ^ \markup {
                            \column
                                {
                                    ...
                                    %%%             #'(box-padding . 0.75) %! EXPLICIT_INSTRUMENT_CHANGE_MARKUP:2
                                    %%%             \box %! EXPLICIT_INSTRUMENT_CHANGE_MARKUP:2
                                    %%%                 "violin II" %! EXPLICIT_INSTRUMENT_CHANGE_MARKUP:2
                                    %%%     } %! EXPLICIT_INSTRUMENT_CHANGE_MARKUP:2
                                    \line %! EXPLICIT_INSTRUMENT_CHANGE_COLORED_MARKUP:3
                                        { %! EXPLICIT_INSTRUMENT_CHANGE_COLORED_MARKUP:3
                                            \with-color %! EXPLICIT_INSTRUMENT_CHANGE_COLORED_MARKUP:3
                                                ...
                                                \override %! EXPLICIT_INSTRUMENT_CHANGE_COLORED_MARKUP:3
                                                    #'(box-padding . 0.75) %! EXPLICIT_INSTRUMENT_CHANGE_COLORED_MARKUP:3
                                                    \box %! EXPLICIT_INSTRUMENT_CHANGE_COLORED_MARKUP:3
                                                        "violin II" %! EXPLICIT_INSTRUMENT_CHANGE_COLORED_MARKUP:3
                                        } %! EXPLICIT_INSTRUMENT_CHANGE_COLORED_MARKUP:3
                                }
                            }
                        \set ViolinTwoMusicStaff.instrumentName = \markup { %! EXPLICIT_INSTRUMENT_SHADOW_COMMAND:6
                            \hcenter-in %! EXPLICIT_INSTRUMENT_SHADOW_COMMAND:6
                                #16 %! EXPLICIT_INSTRUMENT_SHADOW_COMMAND:6
                                \line %! EXPLICIT_INSTRUMENT_SHADOW_COMMAND:6
                                    { %! EXPLICIT_INSTRUMENT_SHADOW_COMMAND:6
                                        Violin %! EXPLICIT_INSTRUMENT_SHADOW_COMMAND:6
                                        II %! EXPLICIT_INSTRUMENT_SHADOW_COMMAND:6
                                    } %! EXPLICIT_INSTRUMENT_SHADOW_COMMAND:6
                            } %! EXPLICIT_INSTRUMENT_SHADOW_COMMAND:6
                        \set ViolinTwoMusicStaff.shortInstrumentName = \markup { %! EXPLICIT_INSTRUMENT_SHADOW_COMMAND:6
                            \hcenter-in %! EXPLICIT_INSTRUMENT_SHADOW_COMMAND:6
                                #10 %! EXPLICIT_INSTRUMENT_SHADOW_COMMAND:6
                                \line %! EXPLICIT_INSTRUMENT_SHADOW_COMMAND:6
                                    { %! EXPLICIT_INSTRUMENT_SHADOW_COMMAND:6
                        ...
                        \override ViolinTwoMusicStaff.InstrumentName.color = #(x11-color 'DarkCyan) %! EXPLICIT_INSTRUMENT_SHADOW_COLOR:5
                        \override ViolinTwoMusicStaff.Clef.color = #(x11-color 'DarkCyan) %! EXPLICIT_CLEF_SHADOW_COLOR:11
