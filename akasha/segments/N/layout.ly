% measure_count = 25
% time_signatures = [
%  '3/8', '4/8', '7/8', '7/8', '3/8', '6/8', '9/8', '9/8', '4/8', '8/8',
%  '6/8', '7/8', '7/8', '3/8', '8/8', '9/8', '9/8', '4/8', '4/8', '3/8',
%  '4/8', '8/8', '9/8', '9/8', '1/4',
%  ]
...
<<                                                                             %! SingleStaffScoreTemplate
    ...
    <<                                                                         %! _make_global_context
        ...
        %@% - \baca-start-spm-left-only "[1/22]"                               %! SPACING_MARKUP
        ...
        %@% \bacaStartTextSpanSPM                                              %! SPACING_MARKUP
            ...
            s1 * 7/8                                                           %! _make_global_skips(1)
        %@% \bacaStopTextSpanSPM                                               %! SPACING_MARKUP
        %@% - \baca-start-spm-left-only "[[1/22 * 35/24]]"                     %! SPACING_MARKUP
        %@% \bacaStartTextSpanSPM                                              %! SPACING_MARKUP
        ...
        %@% \bacaStartTextSpanSPM                                              %! SPACING_MARKUP
            ...
            s1 * 9/8                                                           %! _make_global_skips(1)
        %@% \bacaStopTextSpanSPM                                               %! SPACING_MARKUP
        %@% - \baca-start-spm-both "[1/22]" "[[1/4 * 35/24]]"                  %! SPACING_MARKUP
        %@% \bacaStartTextSpanSPM                                              %! SPACING_MARKUP
