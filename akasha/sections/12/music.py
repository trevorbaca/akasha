...
music = baca.make_mmrests_function(commands.get(29))
voice.extend(music)
...
music = baca.make_mmrests_function(commands.get(40))
voice.extend(music)
...
music = baca.make_mmrests_function(commands.get(55))
voice.extend(music)
...
music = baca.make_mmrests_function(commands.get(69))
voice.extend(music)
