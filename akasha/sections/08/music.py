...
music = baca.make_notes_function(commands.get(5, 7), repeat_ties=True)
voice.extend(music)

music = baca.make_notes_function(commands.get(8, 10), repeat_ties=True)
voice.extend(music)
...
music = baca.make_notes_function(commands.get(1, 4), repeat_ties=True)
voice.extend(music)
