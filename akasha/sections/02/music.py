...
def v1(m):
    with baca.scope(m[6, 7]) as o:
        baca.pitches(o, "E4 F4 E+4", noncyclic=True)
...
def v2(m):
    ...
    with baca.scope(m[6, 7]) as o:
        library.material_annotation_spanner(o, "B")
        baca.pitches(o, "D4 D~4 C4", noncyclic=True)
    with baca.scope(m[9]) as o:
        library.material_annotation_spanner(o, "B")
        baca.pitches(o, "C#4 C#+4", noncyclic=True)
    with baca.scope(m[11, 13]) as o:
        library.material_annotation_spanner(o, "C")
        baca.dynamic(o.pleaf(0), "pp")
        baca.markup(o.pleaf(0), r"\baca-tasto-plus-xfb-markup")
...
def va(m):
    ...
    with baca.scope(m[6, 7]) as o:
        library.material_annotation_spanner(o, "B")
        baca.pitches(o, "Eb4 D4 E4", noncyclic=True)
    library.material_annotation_spanner(m[9], "B")
    baca.pitches(m[9], "C4", noncyclic=True)
    with baca.scope(m[11, 13]) as o:
        library.material_annotation_spanner(o, "B")
        baca.pitches(o, "D4 D+4 D#4 E4 F#4 F4", noncyclic=True)
    library.material_annotation_spanner(m[15], "B")
    baca.pitches(m[15], "Eb4 D4", noncyclic=True)
...
def vc(m):
    ...
    with baca.scope(m[9]) as o:
        library.material_annotation_spanner(o, "B")
        baca.pitches(o, "C4 C~4 B3", noncyclic=True)
    with baca.scope(m[11, 13]) as o:
        library.material_annotation_spanner(o, "B")
        baca.pitches(o, "Bb3 Bb~3 A3 Ab3 G3 A3", noncyclic=True)
    with baca.scope(m[15]) as o:
        library.material_annotation_spanner(o, "B")
        baca.pitches(o, "A3 A#3 B3", noncyclic=True)
...
def make_layout():
    spacing = baca.make_layout(
        baca.page(
            ...
            baca.system(measure=12, y_offset=145, distances=(20, 20)),
        ),
        spacing=(1, 16),
    )
