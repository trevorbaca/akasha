...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.13.Violin.1.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
>>
  ...
  %! baca.path.extern()
number.13.Violin.2.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:
...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.13.Violin.2.Music_Staff = <<
    % ABSOLUTE_BEFORE:
    % COMMANDS:
