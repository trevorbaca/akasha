...
def V1(voice, measures):
    ...
    voice.extend(music)
    music = baca.make_repeated_duration_notes(measures(8, 20), [(1, 4)])
    voice.extend(music)
    music = baca.make_repeat_tied_notes(measures(21, 22))
    voice.extend(music)
    ...
    voice.extend(music)
    music = baca.make_repeat_tied_notes(measures(25, 26))
    voice.extend(music)
    music = baca.make_mmrests(measures(27), head=voice.name)
    voice.extend(music)
    ...
    voice.extend(music)
    music = baca.make_repeat_tied_notes(measures(31, 32))
    voice.extend(music)
    music = baca.make_repeat_tied_notes(measures(33, 34))
    voice.extend(music)
    music = baca.make_repeat_tied_notes(measures(35, 36))
    voice.extend(music)
...
def V2(voice, measures):
    ...
    music = baca.make_mmrests(measures(6, 7), head=voice.name)
    voice.extend(music)
    music = baca.make_repeat_tied_notes(measures(8, 10))
    voice.extend(music)
    music = baca.make_mmrests(measures(11, 12), head=voice.name)
    voice.extend(music)
    music = baca.make_repeated_duration_notes(measures(13, 20), [(1, 4)])
    voice.extend(music)
    music = baca.make_repeat_tied_notes(measures(21, 22))
    voice.extend(music)
    music = baca.make_mmrests(measures(23, 24), head=voice.name)
    voice.extend(music)
    music = baca.make_repeat_tied_notes(measures(25, 26))
    voice.extend(music)
    music = baca.make_mmrests(measures(27), head=voice.name)
...
def VA(voice, measures):
    ...
    music = baca.make_mmrests(measures(3), head=voice.name)
    voice.extend(music)
    music = baca.make_repeated_duration_notes(measures(4, 20), [(1, 4)])
    voice.extend(music)
    music = baca.make_repeat_tied_notes(measures(21, 22))
    voice.extend(music)
    music = baca.make_mmrests(measures(23, 24), head=voice.name)
...
def VC(voice, measures):
    ...
    music = baca.make_mmrests(measures(11, 12), head=voice.name)
    voice.extend(music)
    music = baca.make_repeat_tied_notes(measures(13, 14))
    voice.extend(music)
    music = baca.make_mmrests(measures(15, 16), head=voice.name)
    voice.extend(music)
    music = baca.make_repeated_duration_notes(measures(17, 20), [(1, 4)])
    voice.extend(music)
    music = baca.make_repeat_tied_notes(measures(21, 22))
    voice.extend(music)
    music = baca.make_mmrests(measures(23, 24), head=voice.name)
