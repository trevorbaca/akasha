...
def V1(voice, accumulator):
    ...
    voice.extend(music)
    music = baca.make_repeated_duration_notes_function(accumulator.get(8, 20), [(1, 4)])
    voice.extend(music)
    ...
    voice.extend(music)
    music = baca.make_repeat_tied_notes_function(accumulator.get(31, 32))
    voice.extend(music)
    music = baca.make_repeat_tied_notes_function(accumulator.get(33, 34))
    voice.extend(music)
    music = baca.make_repeat_tied_notes_function(accumulator.get(35, 36))
    voice.extend(music)
...
def VA(voice, accumulator):
    ...
    music = baca.make_mmrests(accumulator.get(3), head=voice.name)
    voice.extend(music)
    music = baca.make_repeated_duration_notes_function(accumulator.get(4, 20), [(1, 4)])
    voice.extend(music)
    music = baca.make_repeat_tied_notes_function(accumulator.get(21, 22))
    voice.extend(music)
    music = baca.make_mmrests(accumulator.get(23, 24), head=voice.name)
...
def VC(voice, accumulator):
    ...
    music = baca.make_mmrests(accumulator.get(11, 12), head=voice.name)
    voice.extend(music)
    music = baca.make_repeat_tied_notes_function(accumulator.get(13, 14))
    voice.extend(music)
    music = baca.make_mmrests(accumulator.get(15, 16), head=voice.name)
    voice.extend(music)
    music = baca.make_repeated_duration_notes_function(
        accumulator.get(17, 20), [(1, 4)]
    )
    voice.extend(music)
    music = baca.make_repeat_tied_notes_function(accumulator.get(21, 22))
    voice.extend(music)
