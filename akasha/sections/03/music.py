...
music = baca.make_mmrests(commands.get(4, 11), head=v1.name)
voice.extend(music)
...
music = baca.make_mmrests(commands.get(4, 9), head=v2.name)
voice.extend(music)
...
music = baca.make_mmrests(commands.get(5), head=vc.name)
voice.extend(music)
